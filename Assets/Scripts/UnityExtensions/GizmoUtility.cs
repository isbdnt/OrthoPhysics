...
namespace UnityExtensions
{
    public static class GizmoUtility
    {
        ...
        public static void DebugCylinder(Vector3 start, Vector3 end, Color color, float radius = 1, float duration = 0, bool depthTest = true)
        {
            ...
            //Radial circles
            GizmoUtility.DebugCircle(start, up, color, radius, duration, depthTest);
            GizmoUtility.DebugCircle(end, -up, color, radius, duration, depthTest);
            GizmoUtility.DebugCircle((start + end) * 0.5f, up, color, radius, duration, depthTest);
        ...
        public static void DebugCone(Vector3 position, Vector3 direction, Color color, float angle = 45, float duration = 0, bool depthTest = true)
        {
            ...
            GizmoUtility.DebugCircle(position + _forward, direction, color, (_forward - (slerpedVector.normalized * dist)).magnitude, duration, depthTest);
            GizmoUtility.DebugCircle(position + (_forward * 0.5f), direction, color, ((_forward * 0.5f) - (slerpedVector.normalized * (dist * 0.5f))).magnitude, duration, depthTest);
        }
        ...
        public static void DebugArrow(Vector3 position, Vector3 direction, Color color, float duration = 0, bool depthTest = true)
        {
            ...
            GizmoUtility.DebugCone(position + direction, -direction * 0.333f, color, 15, duration, depthTest);
        }
        ...
        public static void DrawCylinder(Vector3 start, Vector3 end, Color color, float radius = 1.0f)
        {
            ...
            //Radial circles
            GizmoUtility.DrawCircle(start, up, color, radius);
            GizmoUtility.DrawCircle(end, -up, color, radius);
            GizmoUtility.DrawCircle((start + end) * 0.5f, up, color, radius);
        ...
        public static void DrawCone(Vector3 position, Vector3 direction, Color color, float angle = 45)
        {
            ...
            GizmoUtility.DrawCircle(position + _forward, direction, color, (_forward - (slerpedVector.normalized * dist)).magnitude);
            GizmoUtility.DrawCircle(position + (_forward * 0.5f), direction, color, ((_forward * 0.5f) - (slerpedVector.normalized * (dist * 0.5f))).magnitude);
        ...
        public static void DrawArrow(Vector3 position, Vector3 direction, Color color)
        {
            ...
            GizmoUtility.DrawCone(position + direction, -direction * 0.333f, color, 15);
        ...
        public static void DrawSphere(Vector3 pos, Color color, float radius)
        {
