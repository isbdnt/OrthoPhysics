...
namespace FixMathematics
{
    ...
    public partial struct Fix64 : IEquatable<Fix64>, IComparable<Fix64>
    {
        ...
        public static readonly Fix64 Epsilon = (Fix64)0.0001f;
        /// <summary>
        /// The value of Pi
        /// </summary>
        ...
        public static readonly Fix64 Deg2Rad = Pi / (Fix64)180f;
        ...
        public static Fix64 Square(Fix64 x)
        {
            return x * x;
        }
        ...
        public static bool Approximately(Fix64 x, Fix64 y)
        {
            return Abs(x - y) < Epsilon;
        }

        public static bool Roughly(Fix64 x, Fix64 y)
        {
            return Abs(x - y) < Max(Epsilon * Max(Abs(x), Abs(y)), Epsilon);
        }
